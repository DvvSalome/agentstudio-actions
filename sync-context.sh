...
set -e
BASE_URL="https://raw.githubusercontent.com/JuanGomez-Sequal/agentstudio-core/main"
...
curl -sf "https://raw.githubusercontent.com/JuanGomez-Sequal/agentstudio-board/main/CONTEXT/board-api.md" -o CONTEXT/board-api.md 2>/dev/null || echo "Note: board-api.md not yet available"
echo "Sync complete."
